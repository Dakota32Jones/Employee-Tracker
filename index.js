    ...
    inquirer
      ...
      .then((answer) => {
        ...
        connection.query(sql, [employeeId], (error) => {
          if (error) throw error;
          console.log(chalk.cyanBright.bold("=".repeat(50)));
          console.log(chalk.magentaBright(`Employee Successfully Removed`));
          console.log(chalk.cyanBright.bold("=".repeat(50)));
          viewAllEmployees();
        });
      });
    ...
    inquirer
      ...
      .then((answer) => {
        ...
        connection.query(sql, [roleId], (error) => {
          if (error) throw error;
          console.log(chalk.redBright.bold("=".repeat(50)));
    ...
    inquirer
      ...
      .then((answer) => {
        ...
        connection.query(sql, [departmentId], (error) => {
          if (error) throw error;
          console.log(chalk.blackBright.bold("=".repeat(50)));
          console.log(chalk.blackBright(`Department Successfully Removed`));
          console.log(chalk.blackBright.bold("=".repeat(50)));
          viewAllDepartments();
        });
      });
